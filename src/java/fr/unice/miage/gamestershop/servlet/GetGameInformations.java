 ...
 */
@WebServlet(name="GetGameInformations", urlPatterns={"/GetGameInformations"})
public class GetGameInformations extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Game game = gameManager.getGameById(Integer.parseInt(idGame));
